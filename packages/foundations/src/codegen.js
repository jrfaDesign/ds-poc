 ...
 *
 * AUTO-GENERATED by scripts/generate-codegen.mjs — DO NOT EDIT
 * Edit packages/foundations/src/index.ts instead, then run:
 *   yarn workspace @repo/foundations generate:codegen
 */
...
export const typographyContractKeys = [
	'h1',
	'h2',
	'h3',
	'h4',
...
export const NESTED_CONTRACT_PROPERTIES = {
	actions: ['bg', 'on', 'border', 'bgHover', 'onHover', 'bgActive', 'onActive', 'bgFocus', 'onFocus', 'borderFocus', 'bgDisabled', 'onDisabled', 'borderDisabled'],
	feedback: ['bg', 'on', 'border', 'bgInverse', 'onInverse'],
	surfaces: ['bg', 'on', 'border'],
};

export const FLAT_CONTRACT_PROPERTIES = {
	inputField: ['bg', 'on', 'border', 'placeholder', 'bgHover', 'borderHover', 'bgFocus', 'borderFocus', 'onFocus', 'bgDisabled', 'onDisabled', 'borderDisabled', 'borderError', 'onError', 'borderSuccess', 'onSuccess'],
	selectionControl: ['bg', 'border', 'bgChecked', 'borderChecked', 'onChecked', 'bgHover', 'borderHover', 'bgDisabled', 'borderDisabled', 'onDisabled', 'borderError'],
	toggle: ['trackBg', 'trackBgChecked', 'trackBorder', 'thumbColor', 'thumbColorChecked', 'bgHover', 'trackBgCheckedHover', 'bgDisabled', 'trackBgDisabled', 'thumbDisabled', 'borderError'],
	components: ['buttonBorderRadii', 'cardBorderRadii', 'saleCardRadii', 'inputBorderRadii', 'headerBg', 'headerAvatarBg', 'footerBg', 'footerBgSecondary', 'salesCardBg', 'appShellBg', 'activeTabIndicator', 'saleCardLogoBase'],
};
